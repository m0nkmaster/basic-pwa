...
self.addEventListener('notificationclick', function (event) {
    ...
    var url = 'http://www.theguardian.com/' + event.notification.data.topic + "?page=with:block-" + event.notification.data.blockId + "&CMP=not_b-webalert" + "#block-" + event.notification.data.blockId;
